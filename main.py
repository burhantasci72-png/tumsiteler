...
def fetch_netspor():
    ...
    try:
        ...
        # KATMAN 1: Klasik Netspor Yapısı (Gizli id'leri arar)
        ...
        if not results:
            print("    [!] Klasik yapı yok, Akıllı M3U8 Botu linkleri zorluyor...")
            items_to_fetch =[]
            seen_links = set()
        ...
        # KATMAN 3: HİÇBİR ŞEY BULUNAMAZSA DEVREYE GİREN "GARANTİ YEDEK KANALLAR"
        if not results:
